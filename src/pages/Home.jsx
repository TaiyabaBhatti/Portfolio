...
export default function Home() {
  return (
    <section className="h-[calc(100vh-64px)] relative overflow-hidden bg-theme-blue-dark">
      {/*Icons flow  */}

      <div className="w-[calc(100vw-190px)] h-56  absolute bottom-0  left-0 z-40">
      ...
      <Wrapper>
        <section className="space-y-8 relative mt-24">
          {/* Bio */}
